...
class TestSampleShellCommands(IntegrationTest):
    ...
    def test_query_embedded_documents(self):
        ...
        db.inventory.insert_many([
            {"item": "journal",
             "qty": 25,
             "size": dict([("h", 14), ("w", 21), ("uom", "cm")]),
             "status": "A"},
            {"item": "notebook",
             "qty": 50,
             "size": dict([("h", 8.5), ("w", 11), ("uom", "in")]),
             "status": "A"},
            {"item": "paper",
             "qty": 100,
             "size": dict([("h", 8.5), ("w", 11), ("uom", "in")]),
            ...
            {"item": "planner",
             "qty": 75,
             "size": dict([("h", 22.85), ("w", 30), ("uom", "cm")]),
             "status": "D"},
            {"item": "postcard",
             "qty": 45,
             "size": dict([("h", 10), ("w", 15.25), ("uom", "cm")]),
             "status": "A"}])
        # End Example 14
    ...
    def test_query_array_of_documents(self):
        ...
        db.inventory.insert_many([
            {"item": "journal",
             "instock": [
                 dict([("warehouse", "A"), ("qty", 5)]),
                 dict([("warehouse", "C"), ("qty", 15)])]},
            {"item": "notebook",
             "instock": [
                 dict([("warehouse", "C"), ("qty", 5)])]},
            {"item": "paper",
             "instock": [
                 dict([("warehouse", "A"), ("qty", 60)]),
                 dict([("warehouse", "B"), ("qty", 15)])]},
            {"item": "planner",
             "instock": [
                 dict([("warehouse", "A"), ("qty", 40)]),
                 dict([("warehouse", "B"), ("qty", 5)])]},
            {"item": "postcard",
             "instock": [
                 dict([("warehouse", "B"), ("qty", 15)]),
                 dict([("warehouse", "C"), ("qty", 35)])]}])
        # End Example 29

        # Start Example 30
        cursor = db.inventory.find(
            {"instock": dict([("warehouse", "A"), ("qty", 5)])})
        # End Example 30
        ...
        # Start Example 31
        cursor = db.inventory.find(
            {"instock": dict([("qty", 5), ("warehouse", "A")])})
        # End Example 31
